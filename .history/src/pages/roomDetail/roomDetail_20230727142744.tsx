    ...
    return (
      ...
      {isOpen && (
        <Lightbox
          ...
          prevSrc={document3[(photoIndex + document3.length - 1) % document.length].linkimg} // Thay thế 'data.linkimg[(photoIndex + data.linkimg.length - 1) % data.linkimg.length]' bằng 'document[(photoIndex + document.length - 1) % document.length].linkimg'
