...
import { usePrismicDocumentByUID, PrismicImage, useAllPrismicDocumentsByType } from '@prismicio/react'
                    ...
                    {document3 && document3[2] && (
                        ...
                        >
                            <div className="bg-white cafita overflow-hidden p-3 shadow rounded">
                                <img className="w-100 img-fluid" src={document3[2].data.link_img} style={{
                                    objectFit: "cover",
                                    height: "280px",
                                    maxHeight: "280px",
                                    maxWidth: "250px",
