                    ...
                    <Col xs={auto} md={12} lg={6}>
                        {document3 && document3.map((roomData) => (
                            <div key={roomData.id} className='room-item'>
                                <h3 className='type-roomdetail'>{roomData.data.name_room.text}</h3>
                                {/* Hiển thị thông tin phòng, ví dụ size và số người */}
                                <p>
                                    <FontAwesomeIcon className='icons-roomdetail' icon={faBed} />:{roomData.data.size.text}
                                    <FontAwesomeIcon className='icons-roomdetail' icon={faPerson} />:{roomData.data.people.text}
                                </p>
                            </div>
                        ))}
                    ...
                    <Col data-aos="zoom-in-down" data-aos-duration="1000" xs={auto} md={auto} lg={5} className='justify-content-center'>
                        ...
                        {selectedRoom && (
                            <div className='room-detail'>
                                <h3 className='type-roomdetail'>{selectedRoom.data.name_room.text}</h3>
                                ...
                                <img src={selectedRoom.data.link_img.url} alt={selectedRoom.data.link_img.alt} width={'80%'} height={'90%'} />
                            </div>
                        )}
                    </Col>
                </Row>
