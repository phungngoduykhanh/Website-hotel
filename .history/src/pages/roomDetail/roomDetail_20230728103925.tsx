                    ...
                    <Col data-aos="zoom-in-down" data-aos-duration="1000" xs={auto} md={auto} lg={5} className='justify-content-center'>
                        ...
                        {selectedRoom && (
                            <div className='room-detail'>
                                ...
                                <p><FontAwesomeIcon className='icons-roomdetail' icon={faBed} />:{selectedRoom.data.size[0].text}</p>
                                <p><FontAwesomeIcon className='icons-roomdetail' icon={faPerson} />:{selectedRoom.data.people.text}</p>
