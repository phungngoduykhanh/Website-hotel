                    ...
                    <Col data-aos="zoom-in-down" data-aos-duration="1000" xs={auto} md={auto} lg={5} className='justify-content-center'>
                        ...
                        {selectedRoomId && (
                            <div className='room-detail'>
                                <h3 className='type-roomdetail'>{selectedRoomId.data.name_room}</h3>
                                <p><FontAwesomeIcon className='icons-roomdetail' icon={faBed} />:{selectedRoomId.data.size}</p>
                                <p><FontAwesomeIcon className='icons-roomdetail' icon={faPerson} />:{selectedRoomId.data.people}</p>
                                <p>{selectedRoomId.data.content}</p>
                                {/* Hiển thị hình ảnh phòng */}
                                <PrismicImage field={selectedRoomId.data.link_img} width={'80%'} height={'90%'} />
                            </div>
                        )}
                    </Col>
                </Row>
