    ...
    const images: (string | undefined)[] = [
      ...
      images.map(imageUrl => {
        if (typeof imageUrl === 'string') {
          // Your code here, imageUrl is of type 'string' inside this block
        }
      });
            ...
            body: [
                {
                  items: [
                    {
          data.body[0].items[0].imglink: imageUrl,
        },]
      }]}}));
                    ...
                    return (
                        <Col key={index} data-aos="fade-up" data-aos-duration="500" xs={12} sm={6} md={6} lg={4}>
                            <div className="image-wrapper-roomdetail d-flex justify-content-center ">
                                <PrismicImage key={index} className="images-roomdetail" field={image.data.linkimg}
