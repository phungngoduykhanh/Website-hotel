...
const RoomDetail: React.FC = () => {
    ...
    const images: string[] = [
        ...
        .data.body[1].items[6].imglink,
        data.body[1].items[7].imglink,
        data.body[1].items[8].imglink,
        data.body[1].items[9].imglink,
        data.body[1].items[10].imglink,
        data.body[1].items[11].imglink,
        data.body[1].items[12].imglink,
        data.body[1].items[13].imglink,
    ];
