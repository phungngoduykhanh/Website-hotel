...
import { usePrismicDocumentByUID, PrismicRichText, PrismicImage, usePrismicDocumentsByType } from '@prismicio/react'
...
export default function () {
    ...
    const [doc] = usePrismicDocumentsByType('hotelroom');
                ...
                <Row data-aos="fade-up" className='roomdetail'>
                    ...
                    {document && (
                        <h3 className='type-roomdetail'>
                            {document.data.name_room} </h3><br />
                        <p ><FontAwesomeIcon className='icons-roomdetail' icon={faBed} /><span>:{document.data.size}</span>
                            <FontAwesomeIcon className='icons-roomdetail' icon={faPerson} /> <span>:
