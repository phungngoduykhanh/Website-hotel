...
export default function RoomDetail() {
    ...
    const imageUrls = document3?.map((doc) => doc.data.body.linkimg) || [];
    // if (!document) {
    ...
    return (
        <>
            ...
            <Container className='container-fluid '>
                ...
                {document3 && document3.map((image, index) => (
                    <Col key={index} data-aos="fade-up" data-aos-duration="500" xs={12} sm={6} md={6} lg={4}>
                        <div className="image-wrapper-roomdetail ">
                        <div className="overlay-roomdetail d-flex justify-content-center" onClick={() => openLightbox(index)}>
                            <img
                                src={document3[0].data.body[0].item?.linkimg?.url}
