...
const RoomDetail: React.FC = () => {
    ...
    const images: string[] = [
        ...
        documentdata.body[1].items[6].imglink,
        documentdata.body[1].items[7].imglink,
        documentdata.body[1].items[8].imglink,
        documentdata.body[1].items[9].imglink,
        documentdata.body[1].items[10].imglink,
        documentdata.body[1].items[11].imglink,
        documentdata.body[1].items[12].imglink,
        documentdata.body[1].items[13].imglink,
    ];
