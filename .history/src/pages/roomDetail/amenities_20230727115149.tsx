...
const RoomDetail: React.FC = () => {
    ...
    const amenitiesList = document.data.body[0].items[0].room_amenities;

    // Tạo một mảng amenitiesItems chứa các phần tử li tương ứng với từng nội dung
    const amenitiesItems = amenitiesList.map((amenity, index) => (
        <li key={index}>
