...
const RoomDetail: React.FC = () => {
    ...
    {document && (
    const images: string[] = [
        document.data.body[1].items[4].imglink,
        document.data.body[1].items[5].imglink,
        document.data.body[1].items[6].imglink,
        document.data.body[1].items[7].imglink,
        document.data.body[1].items[8].imglink,
        document.data.body[1].items[9].imglink,
        document.data.body[1].items[10].imglink,
        document.data.body[1].items[11].imglink,
        document.data.body[1].items[12].imglink,
        document.data.body[1].items[13].imglink,
    ];)}
