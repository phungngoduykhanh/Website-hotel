        ...
        <PrismicRichText field={document3[0].data.name_room} />
                ...
                <Row className='suites justify-content-center'>
                    ...
                    {room3 && (
                        ...
                        >
                            <div className="bg-white cafita overflow-hidden p-3 shadow rounded">
                                <img className="w-100 img-fluid" src={room3.data.link_img.url} style={{
                                    objectFit: "cover",
                                    height: "280px",
                                    maxHeight: "280px",
                                    maxWidth: "250px",
                    ...
                    {room5 && (
                        ...
                        >
                            <div className="bg-white cafita overflow-hidden p-3 shadow rounded">
                                <img className="w-100 img-fluid" src={room5.data.link_img.url} style={{
                                    objectFit: "cover",
                                    height: "280px",
                                    maxHeight: "280px",
                                    maxWidth: "250px",
