...
const RoomDetail: React.FC = () => {
    ...
    const images: string[] = [
        ...
        images.data.body[1].items[6].imglink,
        images.data.body[1].items[7].imglink,
        images.data.body[1].items[8].imglink,
        images.data.body[1].items[9].imglink,
        images.data.body[1].items[10].imglink,
        images.data.body[1].items[11].imglink,
        images.data.body[1].items[12].imglink,
        images.data.body[1].items[13].imglink,
    ];
