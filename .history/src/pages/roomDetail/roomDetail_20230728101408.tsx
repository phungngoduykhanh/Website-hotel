        ...
        <>
            ...
            <Container className='container-fluid '>
                ...
                <Row className='suites justify-content-center'>
                    ...
                    {document3 && document3.map((room, index) => (
                        <Col key={index} data-aos="fade-up" data-aos-duration="500" className='type-roomdetail1' xs={12}md={12}
                            lg={3}
                        >
                            <Link
                                to="/detailroom"
                    ...
                    {document3 && document3[2] && (
                        <Link
                            to="/detailroom"
                            className="text-decoration-none text-dark"
                        >
                            <div className="bg-white cafita overflow-hidden p-3 shadow rounded">
                                <img className="w-100 img-fluid" src={document3[2].data.link_img.url} style={{
                                    objectFit: "cover",
                                    height: "280px",
                                    maxHeight: "280px",
                                    maxWidth: "250px",
                                ...
                                >
                                    {document3[2].data.name_room.text}
                    ...
                    {document3 && document3[0] && (
                        ...
                        >
                            <div className="bg-white cafita overflow-hidden p-3 shadow rounded">
                                <img className="w-100 img-fluid" src={document3[0].data.link_img.url} style={{
                                    objectFit: "cover",
                                    height: "280px",
                                    maxHeight: "280px",
                                    maxWidth: "250px",
                                ...
                                >
                                    {document3[0].data.name_room.text}
                    ...
                    {document3 && (
                        ...
                        >
                            <div className="bg-white cafita overflow-hidden p-3 shadow rounded">
                                <img className="w-100 img-fluid" src={document3[1].data.link_img.url} style={{
                                    objectFit: "cover",
                                    height: "280px",
                                    maxHeight: "280px",
                                    maxWidth: "250px",
                                ...
                                >
                                    {document3[1].data.name_room.text}
