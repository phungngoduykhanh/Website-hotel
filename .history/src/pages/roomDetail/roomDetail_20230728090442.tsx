...
import { usePrismicDocumentByUID, PrismicRichText, PrismicImage, usePriuseAllPrismicDocumentsByTypesmicDocumentsByType } from '@prismicio/react'
...
const RoomDetail: React.FC = () => {
    ...
    const [doc] = useAllPrismicDocumentsByType('hotelroom');
                ...
                <Row data-aos="fade-up" className='roomdetail'>
                    ...
                    <Col xs={auto} md={12} lg={6}>
                        <h3 className='type-roomdetail'>
                            {document3 && (<PrismicRichText field={document3.data.name_room} />
                            )}</h3><br />
                        <p ><FontAwesomeIcon className='icons-roomdetail' icon={faBed} /><span>:{document3 && (
                            <PrismicRichText field={document3.data.size} />
                        )}</span>
