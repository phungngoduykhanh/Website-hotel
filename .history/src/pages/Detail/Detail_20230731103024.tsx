...
const Detail: React.FC = () => {
  ...
  const limitedpolice = hotelKTX && hotelKTX.slice(0, 12);
        ...
        <div className="container vh-100">
          <div className="row">
            ...
            <div className="row">
              ...
              <div className="col-md-10">
                <div className="row">
                {limitedpolice && limitedpolice.map(function (police: { data: { body: { items: { room_amenities: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined; }; }[]; }; }: { dat: React.Key | null | undefineda: { body: { items: { room_amenities: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined; }; }[]; }; }, index: React.Key | null | undefined) {
                  return (
                    <div className="col-md-3" key={index}>
                      ...
                      >
                        <AiOutlineCheck /> {police.data.body[0].items.room_amenities} <br />
