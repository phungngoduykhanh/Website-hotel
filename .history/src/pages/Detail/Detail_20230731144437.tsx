...
import { useAllPrismicDocumentsByType, useSinglePrismicDocument, PrismicRichText, RichTextField } from "@prismicio/react";
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="row">
              ...
              <div className="col-md-10">
                <div className="row">
                  {hotelKTX && hotelKTX.data && hotelKTX.data.body && hotelKTX.data.body[0].items.map((item: { amenityname: RichTextField | null | undefined; }, index: React.Key | null | undefined) => (
