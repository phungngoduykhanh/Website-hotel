    ...
    return (
        ...
        <Header/>
            <Container className='container-fluid'><br /><br />
                ...
                <div className="row gallery justify-content-start">
      {Image && Image.map((image, index) => (
        <div key={index} data-aos="fade-up" data-aos-duration="500" className='col-xs-12 col-sm-6 col-md-4 col-lg-4'>
          <div className="image-wrapper-roomdetail d-flex ">
            {image.data && image.data.body && image.data.body[0].items && image.data.body[0].items.map((item: any, itemIndex: number) => (
              <img
                key={itemIndex}
