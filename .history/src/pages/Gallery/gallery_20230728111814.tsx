...
Make sure to place this code in the appropriate part of your application where it will be executed when needed. The images array will now contain the image URLs from Prismic's link_image property.
