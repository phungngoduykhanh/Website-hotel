...
const Gallery: React.FC = () => {
    ...
    // Call the useAllPrismicDocumentsByType function to fetch data from Prismic
    const galleryData = useAllPrismicDocumentsByType('gallery');
  
    // Update the state 'Image' with the fetched data when 'galleryData' changes
    useEffect(() => {
      return setImage(async function (params: type): Promise<void> {
          galleryData;
      });
    }, [galleryData]);
    return (
